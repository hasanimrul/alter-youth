...
const Footer = () => {
  return (
    <div className="main-container bg-gray-100 py-10">
      <div className="boxed-content lg:px-10 px-3">
        <h3 className="text-md font-semibold">Learn About AlterYouth</h3>
        <div className="flex justify-between items-end">
          <ul className="text-sm flex flex-col gap-2 lg:gap-1 pt-2">
            <li>
              <Link href="/">Home</Link>
            </li>
            <li>
        ...
        <div className="flex items-center gap-2 lg:hidden pt-3">
        ...
        <hr className="w-full bg-gray-300 h-[2px] my-5 lg:hidden" />
